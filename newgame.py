...
# idk why my button  doent work


SPACE = pygame.transform.scale(pygame.image.load(
    os.path.join('Assets', 'lo.jpg')), (WIDTH, HEIGHT))
BACKGROUND_SOUND = pygame.mixer.Sound('Assets/romeo.mp3')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("Assets/pelo.png")
...
while running:
    ...
    button = WINNER_FONT ,Button(pygame.image.load("Assets/beach.jpg"),(0,0),"Hello")
